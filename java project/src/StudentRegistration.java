...
public class StudentRegistration {
    ...
    public static String courses[] = { "(IT) Information Technology", "Data Science", "Computer Science",
    ...
    public static Account[] allAccounts = new Account[1000];
    ...
    public static void main(String[] args) {
        ...
        // label
        JLabel WelcomeLabel = new JLabel("Welcome To Student Registration", SwingConstants.CENTER);
    ...
    public static void FinishCreateAccount(JFrame CreateAccountFrame, String ID) {
        ...
        if (name.isEmpty() || age.isEmpty() || phonenumber.isEmpty() || email.isEmpty() || yearLevel.isEmpty()
                || password.isEmpty()) {
            JOptionPane.showMessageDialog(null, "All fields are required!", "Information Massage",
        ...
        for (int i = 0; i < CountAccount; i++) {
            if (allAccounts[i].getName().equals(name)) {
                JOptionPane.showMessageDialog(null, "Account name already exists!", "Information Message",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
        ...
        Account newAccount = new Account(name, age, phonenumber, gender, section, course, yearLevel, email, password,
                ID);
    ...
    public static void finishLogin(JFrame logFrame, JFrame mainframe) {
        ...
        for (int i = 0; i < CountAccount; i++) {
            if (allAccounts[i].getEmail().equals(username) && allAccounts[i].getPassword().equals(passwordLogin)) {
                ...
                JOptionPane.showMessageDialog(null, "Successfully Login!", "Information Massage",
    ...
    public static void securityscreen(Account account, JFrame studentDashboardFrame, JFrame mainframe) {
        ...
        submitButton.addActionListener(e -> {
            ...
            if (!newPassword.isEmpty()) {
                ...
                securityFrame.dispose();
                JOptionPane.showMessageDialog(null, "Password successfully changed!", "Information Massage",
                        JOptionPane.INFORMATION_MESSAGE);
                System.out.println("Password successfully changed!");
                studentDashboard(account, mainframe);
            } else {
                JOptionPane.showMessageDialog(null, "You need to fill this out!", "Information Massage",
                        JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    public static void updateScreen(Account account, JFrame studentDashboardFrame, JFrame mainframe) {
        ...
        submitButton.addActionListener(e -> {
            ...
            if (!newname.isEmpty() && !newage.isEmpty() && !newphonenumber.isEmpty() && !newemail.isEmpty()
                    && !newyearLevel.isEmpty()) {
    ...
    public static void deleteScreen(Account account, JFrame studentDashboard, JFrame mainframe) {
        ...
        deleteButton.addActionListener(e -> {
            int answer = JOptionPane.showConfirmDialog(null, "You want to delete your account?", "Delete Account",
            ...
            if (answer == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Account Successfully Deleted!", "Information Massage",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    public static class Account {
        ...
        public Account(String name, String age, String phoneNumber, String gender, String section, String course,
                String yearLevel, String email, String password, String ID) {
            this.name = name;
            this.age = age;
