...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\Horve\Documents\Code Projects\pythonProject\PIT code\build\assets\frame4")
...
payment_window = Tk()
payment_window.geometry("1282x779")
payment_window.configure(bg = "#E5E5E5")
...
def open_payment_options():
    open_payment_options = Tk()
    open_payment_options.geometry("1282x779")
    open_payment_options.configure(bg = "#E5E5E5")
    open_payment_options.resizable(False, False)
    open_payment_options.title("Payment Options")
...
table_frame = tk.Frame(payment_window, bg="#FFFFFF")
